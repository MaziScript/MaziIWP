    ...
    var horizontal = function(){
        ...
        chapterData.handle = chapterData.handle.replace(regex.horizontal, function(match, pos, originalText){
            chapterData.horizontalPart.push(
                utils.removeEndingChars(utils.removeBeginningChars((function(){
        ...
        chapterData.horizontalPart.push(
            utils.removeEndingChars(utils.removeBeginningChars(chapterData.handle.substring(tpos-sharp), "#\n"), "\n")
        );
        ...
        (function(){
            for(var i in chapterData.horizontalPart){
                ...
                text = text.replace(regex.language, function(match, pos, originalText){
                    chapterData.command.push(match.substring(3));
                    return "";
                });
                ...
                if(flagType == 1){
                    (function(){
                        //
                        //区分是否存在作者留言
                        var append = typeof text.match(regex.contentAppend) == "undefined";
